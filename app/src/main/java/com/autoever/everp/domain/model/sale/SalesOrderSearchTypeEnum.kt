...
enum class SalesOrderSearchTypeEnum {
     ...
     * 주문번호 검색 여부
     */
    fun isSalesOrderNumberSearch(): Boolean = this == salesOrderNumber
